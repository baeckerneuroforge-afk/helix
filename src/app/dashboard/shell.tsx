...
interface NavItem {
  href: string;
  label: string;
  /** One line under the topbar title — says what the page is for. */
  subtitle: string;
    ...
    items: [
      {
        href: '/dashboard',
        label: 'Übersicht',
        subtitle: 'Kennzahlen und Aktivität der Organisation auf einen Blick',
        icon: <Icon d="M3 3h8v8H3zM13 3h8v5h-8zM13 12h8v9h-8zM3 15h8v6H3z" />,
      },
      {
        href: '/dashboard/chat',
        label: 'Chat',
        subtitle: 'Fragen ans geprüfte Wissen — Antworten mit Quellen',
        icon: <Icon d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.8-.9L3 21l1.9-5.7a8.5 8.5 0 1 1 16.1-3.8z" />,
      },
      {
        href: '/dashboard/knowledge',
        label: 'Wissensbasis',
        subtitle: 'Dokumente der Organisation — Sichtbarkeit inklusive',
    ...
    items: [
      {
        ...
        label: 'Skills',
        subtitle: 'Abläufe starten — Guardrails und Freigaben inklusive',
        icon: <Icon d="M13 2 3 14h7l-1 8 10-12h-7l1-8z" />,
      },
      {
        href: '/dashboard/runs',
        label: 'Ausführungen',
        subtitle: 'Jeder Lauf mit Status, Schritten und Ergebnis',
        icon: <Icon d="M12 22a10 10 0 1 0-10-10M2 22l5-5M2 17v5h5" />,
      },
      {
        href: '/dashboard/approvals',
        label: 'Freigaben',
        subtitle: 'Handelnde Schritte, die auf eine menschliche Entscheidung warten',
    ...
    items: [
      {
        ...
        label: 'Audit',
        subtitle: 'Append-only Protokoll — nichts wird verändert oder gelöscht',
      ...
      },
      {
        ...
        label: 'Einstellungen',
        adminOnly: true,
        subtitle: 'Freigabe-Regeln, Sichtbarkeit, Rollen, Slack, DSGVO',
...
function pageHeader(pathname: string): { title: string; subtitle: string } {
  if (pathname.startsWith('/dashboard/runs/')) {
    return { title: 'Ausführung', subtitle: 'Schritt-Timeline, Freigaben und Ergebnis dieses Laufs' };
  }
